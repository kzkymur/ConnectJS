...
export type ActionHistory = (NodeAction | ActionHistory)[];

type OperatingMethod = (actions?: NodeAction[]) => void;
type OperateType = (operationType: OperationType, actions?: NodeAction[]) => ReverseActionBranch;
export default class ReverseActionBranch {
  current: Partition = {};
  private actionQue: NodeAction[] = [];
